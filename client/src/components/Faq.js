...
export default function Faq({history}) 
    ...
    <ul class="faq-text">
      ...
      <li>
        <div class="question-arrow">
          <span class="question">What is the next step after sending request for account opening?</span>
          <i class="bx bxs-chevron-down arrow"></i>
        </div>
      ...
      <li>
        <div class="question-arrow">
          <span class="question">What happen if my account opening request will be rejected?</span>
          <i class="bx bxs-chevron-down arrow"></i>
        </div>
