      ...
      <div className="gradient">
        <nav className="navbar navbar-light ">
          <div className="container-fluid ">
            ...
            <button className="btn btn-outline-light btn-sm px-2" type="submit">
              Sign out
            </button>
          </div>
        </nav>
              ...
              <div className="media align-items-end profile-head">
                <div className="profile ps-3 mr-5 mt-5">
                  <img
                    ...
                    src="https://images.unsplash.com/photo-1422728280635-45167d8b7197?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTU3fHxwZXJzb258ZW58MHwyfDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
                    alt="..."
                    width="190"
                  />
                </div>
